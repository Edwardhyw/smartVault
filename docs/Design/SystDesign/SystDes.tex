...
\hline Angle per step&float&TBD&Degree/step& \\

\hline Height of the Camera&float&TBD&mm&\\
\hline Angular Velocity&float&TBD&Degree/sec&\\
\hline Resolution&Integer&1920x1080&Pixel&\\
\hline Arduino input voltage&float&9.0&V&\\
\hline &&&&\\
