	...
	\begin{table}[ht]
		...
		\makebox[\linewidth]{
			\begin{tabular}{|p{2.5cm}|p{2.5cm}|p{3cm}|p{2.5cm}|p{1.5cm}|p{2.5cm}|p{1cm}|p{1cm}|}
				...
				Object Detection & Connection lost with camera live feed & a.Temporary internet lost & a.There will be no video frames for SmartVault to process and monitoring object movement & High & a.System output error message to user and retry connecting & NA & \multirow{2}{*} {H5-1} \\ 
				& & b.Camera system is out of  battery & b.Same as H5-1a &  & b. Refer to H1- & & \\ \cline{2-8}
				
				& Object detection faults & a. Unable to detect moving object   & a.SmartVault will not be able to update the specific item's new position & High & a.Well rehearsed image processing and detection method will be implemented to mitigate the chance of this event & SR6  & \multirow{2}{*} {H5-2} \\ 
