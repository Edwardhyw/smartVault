...
Human Body Detection & Human body detection failure & a. Detection method Failure & a. Wrong position description of the objects& High & a. Restart the program & SR4 & \multirow{3}{*} {H2-1} \\ 
				...
				User Interface & App closes unexpectedly & Host device loses power, or Crash due to instabilty & Current progress is lost & High & a. Store 				 	unsaved data locally on user's device & SR9 & H3-1 \\ \cline{2-8}
